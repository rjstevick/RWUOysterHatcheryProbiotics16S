...
dataall<-read.xlsx("Oceano_Bacillus_Vibrio_TotalReads.xlsx", sheet="edit")
datatrial1<-filter(dataall,Trial==1)

grouped_data1 <- group_by(datatrial1, Type, Day, Treatment)
data_means1 <- summarise(grouped_data1,
